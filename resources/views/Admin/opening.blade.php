                        ...
                        <form class="auth-form login-form" action="{{ route('openings.store') }}" method="POST">
                            ...
                            <div class="app-card-body px-4">
                                <div class="row">
                                    ...
                                    <input type="hidden" name="is_new_opening" value="true">
                                </div>
                                <div class="col-md-6">
                                    <br>
                                    <div class="mt-2">
                                        ...
                                        @foreach ($openings as $index => $opening)
                                            <tr>
                                                ...
                                                <td class="cell">
                                                    ...
                                                    <form action="{{ route('openings.destroy', $opening->id) }}"
        ...
        <div class="modal-dialog">
            <form class="modal-content" method="POST" id="editForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="lable_style" for="opening">Opening</label>
                        <input id="editOpening" name="opening" type="text" class="form-control"
                            placeholder="Enter opening" required>
                    </div>
                    <input type="hidden" name="open_id" id="open_id">
                    <input type="hidden" name="is_new_opening" id="is_new_opening" value="true">
                </div>
...
@section('js')
    <script>
        $('#editGradeModal').on('show.bs.modal', function(event) {
            ...
            var actionUrl = "{{ route('openings.update') }}";
            ...
            modal.find('#grade_id').val(id); // Set the grade_id hidden input value
        });
    </script>
@endsection
